...
module.exports = function (req, res, url) {
		...
		case '/videomaker/full/': {
			...
			params = {
				flashvars: {
					...
					'ut': 23, 'bs': 'default', 'appCode': 'go', 'page': '', 'siteId': 'go', 'lid': 13, 'isLogin': 'Y', 'retut': 1,
					'clientThemePath': process.env.CLIENT_URL + '/<client_theme>', 'themeId': 'business', 'tlang': 'en_US',
					'presaveId': presave, 'goteam_draft_only': 0, 'isWide': 1, 'nextUrl': '/dashboard/videos',
				},
	...
	res.end(
	`<link rel="stylesheet" href="https://goanimateforschools.github.io/css/common_combined.css.gz.css"><link rel="stylesheet" href="https://goanimateforschools.github.io/fonts/schoolfont.css"><link rel="stylesheet" href="https://goanimateforschools.github.io/css/importer.css.gz.css"><link rel="stylesheet" href="https://goanimateforschools.github.io/css/studio.css.gz.css"><script src="https://goanimateforschools.github.io/js/common_combined.js.gz.js"></script><script>document.title='${title}',flashvars=${JSON.stringify(
	params.flashvars
